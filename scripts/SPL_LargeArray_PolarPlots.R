...
###################################################################
#Create polar plots of SPL per hour - BOAT BAND SPL (500 to 980 Hz)
#######################################################################

#TAYLOR ISLET SPL

SPL_TI2<-read.csv("odata/24hrAnnotations_AllSites_Selection_Tables/SPL/SPL_1min_24HRSUBSAMPLE_TI_500to1000Hz.csv")
...
#can use meandB() and sddB() from seewave for energy averaged mean if necessary
...
SPL_DR2<-read.csv("odata/24hrAnnotations_AllSites_Selection_Tables/SPL/SPL_1min_24HRSUBSAMPLE_DR_500to1000Hz.csv")
...
SPL_OH2<-read.csv("odata/24hrAnnotations_AllSites_Selection_Tables/SPL/SPL_1min_24HRSUBSAMPLE_OH_500to1000Hz.csv")

#remove loud SPL minute from echosounder pinging interference (minutes 27-33 and 58 to 3)

SPL_OH2 <- SPL_OH2 %>%
  filter(
    !(minute(Date) %in% 28:33 |
        minute(Date) %in% c(58, 59, 0:3))
  )
...
ggsave(
  filename = "combined_polar_SPL_500to1000Hz.png",       # output file name
...
boat_img_path <- "figures/CH3/combined_polar_SPL_500to1000Hz.png"
...
ggsave(
  filename = "combined_polar_FS_SPL_500to1000.png",       # output file name
...
########################################
#Polar Plots SPL - Full bandwidth 
#########################################

# #TAYLOR ISLET SPL - full bandwidth
# 
# SPL_TI2<-read.csv("odata/24hrAnnotations_AllSites_Selection_Tables/SPL/SPL_TI_fullbandwidth.csv")
# 
# #separate Date column into date and time
# SPL_TI2 <- SPL_TI2 %>%
#   separate(Date, into = c("Date", "Time"), sep = " ")
...
# #Danger Rocks SPL
# 
# SPL_DR2<-read.csv("odata/24hrAnnotations_AllSites_Selection_Tables/SPL/SPL_DR_fullbandwidth.csv")
# 
# #separate Date column into date and time
# SPL_DR2 <- SPL_DR2 %>%
#   separate(Date, into = c("Date", "Time"), sep = " ")
...
# #Ohiat Island SPL
# 
# SPL_OH2<-read.csv("odata/24hrAnnotations_AllSites_Selection_Tables/SPL/SPL_OH_fullbandwidth.csv")
# 
# #separate Date column into date and time
# SPL_OH2 <- SPL_OH2 %>%
#   separate(Date, into = c("Date", "Time"), sep = " ")
...
# 
# ggsave(
#   filename = "combined_polar_SPL_fullbandwithALLSITES.png",       # output file name
#   plot = combined_with_image,                 # plot object
#   path = "figures/CH3",                  # folder path
#   width = 16,                            # width in inches
#   height = 6,                            # height in inches
...
# )
# 
# #code to link SPL plots to fish sound plots
# 
# # ggsave(
